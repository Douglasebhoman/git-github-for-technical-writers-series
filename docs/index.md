...
| Part | Title |
|------|-------|
| Intro | [Introduction — Why Git and GitHub Matter for Technical Writers](introduction.md) |
| 1 | [Git Basics for Technical Writers](part-1-git-basics.md) |
| 2 | [Git vs GitHub — Understanding the Documentation Workflow](part-2-git-vs-github.md) |
| 3 | [From Editing Files to Managing Versions](part-3-versioning.md) |
| 4 | [Pull Requests — Controlling Documentation State](part-4-pull-requests.md) |
| 5 | [CI/CD for Technical Writers](part-5-cicd-pipelines.md) |
| 6 | [Documentation Architecture — Structuring Docs-as-Code for Scale](part-6-repo-architecture.md) |
...
[douglasebhoman.com](https://douglasebhoman.com) · [LinkedIn](https://linkedin.com/in/douglas-ebhoman-757329289) · [GitHub](https://github.com/Douglasebhoman)
